...
MODEL_NAME="llava-finetune-my-model-name-100%"
...
accelerate launch \
    ...
    --pretrain_mm_speech_adapter "my_checkpoint_path_to_a_pretrained_model/mm_speech_projector.bin" \
    --model_name_or_path "meta-llama/Meta-Llama-3.1-8B-Instruct" \
    --version llama_3_1 \
    --data_config_path scripts/data_configs/mix.yml\
    --modality audio \
